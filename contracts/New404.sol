...
// New404 contract inherits ERC404 to create a custom token with both ERC-20 and ERC-721 features
contract New404 is ERC404 {
    ...
    constructor(address _owner) ERC404("New404", "New404", 18, 10000, _owner) {
